...
class TestSolver:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Solver) -> None:
        respx_mock.post("/alpha/repos/github/org/repo/sessions").mock(
            side_effect=httpx.TimeoutException("Test timeout error")
        )

        with pytest.raises(APITimeoutError):
            client.repos.sessions.with_streaming_response.create(
    ...
    @mock.patch("solverai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Solver) -> None:
...
class TestAsyncSolver:
    ...
    @mock.patch("solverai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncSolver) -> None:
        respx_mock.post("/alpha/repos/github/org/repo/sessions").mock(
            side_effect=httpx.TimeoutException("Test timeout error")
        )

        with pytest.raises(APITimeoutError):
            await async_client.repos.sessions.with_streaming_response.create(
                repo="repo", provider="github", org="org", user_branch_name="userBranchName"
            ).__aenter__()
    ...
    @mock.patch("solverai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncSolver) -> None:
        respx_mock.post("/alpha/repos/github/org/repo/sessions").mock(return_value=httpx.Response(500))
